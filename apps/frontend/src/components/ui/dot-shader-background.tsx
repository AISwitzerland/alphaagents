...
// Extend THREE namespace for custom material
declare global {
  namespace JSX {
    interface IntrinsicElements {
      dotMaterial: React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
        resolution?: number[];
        rotation?: number;
        gridSize?: number;
...
function Scene({ theme = 'dark' }: SceneProps) {
...
export function DotShaderBackground({ theme = 'dark', className }: DotShaderBackgroundProps) {
